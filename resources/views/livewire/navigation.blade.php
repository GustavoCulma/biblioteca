        ...
        <nav id="navigation-menu" x-show="open" :class="{'block': open, 'hidden': !open}"
            ...
            <div class="container h-full hidden md:block">
                <div x-on:click.away="close()" class="grid grid-cols-4 h-full relative">
                    <ul class="bg-white">
                        <p class="text-lg font-bold text-center text-gray-600 mb-3">Editoriales</p>
                        @foreach ($editorials as $editorial)
                            <li class="navigation-link text-gray-600 hover:bg-orange-400 hover:text-white">
                                ...
                                <div class="navigation-submenu bg-gray-100 absolute w-3/4 h-full top-0 right-0 hidden">
                                    <x-navigation-books :editorial="$editorial" />
                                </div>
                            </li>
                        @endforeach
                    </ul>
                    <div class="col-span-3  bg-gray-100 ">
                        <x-navigation-books :editorial="$editorials->first()" />
                    </div>
                </div>
            </div>
